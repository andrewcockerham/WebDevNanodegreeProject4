...
This is my Project 4 for the Udacity Web Development Nanodegree.
...
* remove web fonts
* remove unused css re: buttons/input etc
* remove unnecessary strong css (font-weight bold)
* move .hero class css inline
